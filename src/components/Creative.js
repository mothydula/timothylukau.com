...
const Creative = () => {
    return (
        <div>
            <Container><h1 style={{ fontFamily: "Basis Grotesque Pro Bold", color: "white" }}>Creative</h1></Container>
            <Row style={{ margin: 15 }}>
                <Container data-aos="fade-right" style={{ marginTop: 20, borderStyle: "solid", borderColor: "white" }}>
                ...
                <Container data-aos="fade-left" style={{ marginTop: 20, borderStyle: "solid", borderColor: "white" }}>
                    <Row style={{ marginLeft: 0, marginRight: 0 }}>
                        <Col>
